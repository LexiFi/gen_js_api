...
let (_ : (label:int -> ?opt:((int)[@js.default 42]) -> unit -> unit) of_js) =
  fun x68 ->
    fun ~label:x69 ->
      fun ?opt:x70 ->
        fun () ->
            ...
            (Ojs.call x68 "apply"
               [|Ojs.null;((let x71 =
                            ...
                            (match x70 with
                             ...
                             | None -> ());
                            x71))|])
let (_ : (label:int -> ?opt:((int)[@js.default 42]) -> unit -> unit) to_js) =
  fun x73 ->
    Ojs.fun_to_js 2
      (fun x74 ->
         fun x75 ->
...
module B :
  sig
    ...
    val builder6 :
      ?x:((int)[@js.default 42]) ->
        ?y:((string)[@js.default "42"]) -> ?z:int -> unit -> Ojs.t[@@js.builder
                                                                    ]
...
module T :
  sig
    ...
    type status =
      ...
      | OtherI of int [@js.default ][@@js.enum ]
    type poly =
      (([ `foo  | `bar [@js 42] | `Baz  | `I of int [@js.default ]
        | `S of string [@js.default ]])[@js.enum ])
    type sum =
      | A 
      | B of int 
      | C of int * string 
      ...
      age: int ;
      name: string } 
      | Unknown of Ojs.t [@js.default ][@@js.sum ]
    type t =
      | A [@js "A"]
      ...
      | Unknown of Ojs.t [@js.default ][@@js.sum "kind"]
    type union =
      | A 
      | B of int 
      | C of int 
      | D of Ojs.t [@js.default ][@@js.union ]
    type poly_union =
      (([ `A  | `B of int  | `C of int  | `D of Ojs.t [@js.default ]])
      [@js.union ])
    type discr_union =
      | A 
      | B of int 
      | C of int 
      | D of Ojs.t [@js.default ][@@js.union on_field "discr"]
    type discr_poly_union =
      (([ `A  | `B of int  | `C of int  | `D of Ojs.t [@js.default ]])
      [@js.union on_field "discr"])
