...
val explode : t -> t list [@@js.custom let explode x = Ojs.list_of_js wrap x]
...
val update_text : t -> (int -> string -> string) -> unit [@@js.call "text"]

val append_html : t -> string -> unit [@@js.call "append"]

val append : t -> (t list[@js.variadic]) -> unit [@@js.call "append"]
...
val get_val : t -> string [@@js.call "val"]
...
val set_height : t -> ([ `String of string | `Int of int ][@js.union]) -> unit
  [@@js.call "height"]

val width : t -> int [@@js.call]

val set_width : t -> ([ `String of string | `Int of int ][@js.union]) -> unit
  [@@js.call "width"]
...
val set_css_value :
  t -> string -> ([ `String of string | `Float of float ][@js.union]) -> unit
  [@@js.call "css"]
...
val ready : (unit -> unit) -> unit [@@js.global "jQuery"]
...
module Dialog : sig
  ...
  val settings :
    ?modal:bool -> ?title:string -> ?buttons:button list -> unit -> settings
    [@@js.builder]
end
...
module UI : sig
  module Datepicker : sig
    ...
    val settings : ?date_format:string -> unit -> settings [@@js.builder]
  end
...
val dialog :
  t -> ([ `Dialog of Dialog.settings | `String of string ][@js.union]) -> unit
...
module Ajax : sig
  ...
  val run : settings -> unit [@@js.global "jQuery.ajax"]
