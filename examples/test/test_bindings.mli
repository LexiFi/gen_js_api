...
module Canvas : sig
  ...
  val of_element : Element.t -> t [@@js.cast]

  val getContext_2d : t -> RenderingContext2D.t
    [@@js.custom
      val get_context : t -> string -> Ojs.t [@@js.call]

      let getContext_2d x = get_context x "2d"]
end
...
module Person : sig
  ...
  val create : string -> Foo.t -> t [@@js.new "Person"]

  val name : t -> string

  val foo : t -> Foo.t

  val get : t -> unit -> string * Foo.t [@@js.call]

  val set : t -> string * Foo.t -> unit [@@js.call]
...
module PersonObj : sig
  ...
  val create : string -> Person.Foo.t -> t [@@js.new "Person"]

  val of_person : Person.t -> t [@@js.cast]
end
...
module Str : sig
  ...
  val create : string -> t [@@js.new "String"]
end

module Date : sig
  type t = private Ojs.t

  val create : year:int -> month:int -> ?day:(int[@js.default 0]) -> unit -> t
    [@@js.new "Date"]
...
module Person2 : sig
  ...
  val to_json : t -> string [@@js.global "JSON.stringify"]
end

type int_or_string_or_null = Int of int | String of string | Nothing
[@@js.union]
...
module Verb1 : sig
  type t1 = { x_coord : int; y_coord : int }
...
module Verb2 : sig
  type t1 = { x_coord : int; y_coord : int } [@@js.verbatim_names]
