...
module Dirent =
  struct
    ...
    let (is_directory : t -> bool) =
      fun (x5 : t) ->
        Ojs.bool_of_js
          (Jsoo_runtime.Js.meth_call (t_to_js x5) "isDirectory" [||])
  end
module Dir =
  struct
    type t = Ojs.t
  ...
  struct
    ...
    let (append_file : t -> Buffer.t -> unit Promise.t) =
      fun (x19 : t) ->
        fun (x18 : Buffer.t) ->
          Promise.t_of_js Ojs.unit_of_js
            (Jsoo_runtime.Js.meth_call (t_to_js x19) "appendFile"
               [|(Buffer.t_to_js x18)|])
            ...
            fun (x23 : int) ->
              fun (x24 : int) ->
                Promise.t_of_js read_of_js
                  (Jsoo_runtime.Js.meth_call (t_to_js x25) "read"
    ...
    let (chmod : t -> int -> unit Promise.t) =
      fun (x28 : t) ->
        fun (x27 : int) ->
          Promise.t_of_js Ojs.unit_of_js
            (Jsoo_runtime.Js.meth_call (t_to_js x28) "chmod"
               [|(Ojs.int_to_js x27)|])
    let (chmown : t -> uid:int -> gid:int -> unit Promise.t) =
      fun (x32 : t) ->
        fun ~uid:(x30 : int) ->
          fun ~gid:(x31 : int) ->
            Promise.t_of_js Ojs.unit_of_js
              (Jsoo_runtime.Js.meth_call (t_to_js x32) "chmown"
                 [|(Ojs.int_to_js x30);(Ojs.int_to_js x31)|])
    let (close : t -> unit Promise.t) =
      fun (x34 : t) ->
        Promise.t_of_js Ojs.unit_of_js
          (Jsoo_runtime.Js.meth_call (t_to_js x34) "close" [||])
